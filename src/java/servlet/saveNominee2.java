 ...
 * @author Tuhin
 */
@WebServlet(name = "saveNominee2", urlPatterns = {"/saveNominee2"})
public class saveNominee2 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        System.out.println("json2: "+jsonBody);
        ...
        try {
            ...
            cs = conn.prepareCall(DBConstraints.EKYC_SAVE_NOMINEE2);
