 ...
 * @author Tuhin
 */
@WebServlet(name = "saveNominee3", urlPatterns = {"/saveNominee3"})
public class saveNominee3 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        System.out.println("json3: "+jsonBody);
        ...
        try {
            ...
            cs = conn.prepareCall(DBConstraints.EKYC_SAVE_NOMINEE3);
            ...
            cs.setString(12, stat);
            cs.setString(13, nomineeAddType);
            cs.setString(14, nomineeAdd);
            cs.setString(15, nomineePin);
